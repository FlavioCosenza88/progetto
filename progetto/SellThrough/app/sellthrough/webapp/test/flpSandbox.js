		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#SellThroughsellthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SellThroughsellthrough-display": {
								"semanticObject": "SellThroughsellthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SellThrough.sellthrough",
									"url": sap.ui.require.toUrl("SellThrough/sellthrough")
								}
							}
						}
					}
