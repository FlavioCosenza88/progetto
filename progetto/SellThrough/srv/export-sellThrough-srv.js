...
'SKU DESCRIPTION',
'PHOTO',
'VALUE ORDERED WHOLESALE UN',
'VALUTA VALUE ORDERED WHOLESALE UN',
'TOT QTY ORDERED (PZ)',
'TOT VALUE ORDERED',
...
'SELL-THROUGH SU VALUE RECEIVED NO WH % STAGIONE DUE'];
        ...
        for (let i = 0; i < lineItems.length; i++) {
            ...
            worksheet.cell(row + 1, 6).string(item.SUBGENDER ? item.SUBGENDER : "").style(style);
            worksheet.cell(row + 1, 7).string(item.FAMILY_GROUP ? item.FAMILY_GROUP : "").style(style);
            worksheet.cell(row + 1, 8).string(item.PRODUCT_GROUP ? item.PRODUCT_GROUP : "").style(style);
            worksheet.cell(row + 1, 9).string(item.SKUS ? item.SKUS : "").style(style);
            worksheet.cell(row + 1, 10).string(item.SKU_DESCRIPTION ? item.SKU_DESCRIPTION : "").style(style);
            worksheet.cell(row + 1, 11).string().style(style);
            worksheet.cell(row + 1, 12).string((item.VALUE_ORDERED_WHOLESALE_UN ? item.VALUE_ORDERED_WHOLESALE_UN : "")).style(style);
            worksheet.cell(row + 1, 13).string((item.VALUTA_VALUE_ORDERED_WHOLESALE_UN ? item.VALUTA_VALUE_ORDERED_WHOLESALE_UN : "")).style(style);
            worksheet.cell(row + 1, 14).number(item.TOT_QTY_ORDERED).style(style);
            worksheet.cell(row + 1, 15).string(item.CC_TOT_VALUE_ORDERED ? item.CC_TOT_VALUE_ORDERED : "").style(style);
            worksheet.cell(row + 1, 16).number(item.QTY_ORDERED_WHOLESALE).style(style);
            worksheet.cell(row + 1, 17).string(item.CC_VALUE_ORDERED_WHOLESALE ? item.CC_VALUE_ORDERED_WHOLESALE : "").style(style);
            worksheet.cell(row + 1, 18).number(item.CC_QTY_ORDERED_NO_WHOLESALE).style(style);
            worksheet.cell(row + 1, 19).string(item.CC_VALUE_ORDERED_NO_WHOLESALE ? item.CC_VALUE_ORDERED_NO_WHOLESALE: "").style(style);
            worksheet.cell(row + 1, 20).number(item.TOT_QTY_RECEIVED).style(style);
            worksheet.cell(row + 1, 21).string(item.CC_TOT_VALUE_RECEIVED ? item.CC_TOT_VALUE_RECEIVED : "").style(style);
            worksheet.cell(row + 1, 22).number(item.QTY_RECEIVED_WHOLESALE).style(style);
            worksheet.cell(row + 1, 23).string(item.CC_VALUE_RECEIVED_WHOLESALE ? item.CC_VALUE_RECEIVED_WHOLESALE : "").style(style);
            worksheet.cell(row + 1, 24).number(item.CC_QTY_RECEIVED_NO_WHOLESALE).style(style);
            worksheet.cell(row + 1, 25).string(item.CC_VALUE_RECEIVED_NO_WHOLESALE ? item.CC_VALUE_RECEIVED_NO_WHOLESALE : "").style(style);
            worksheet.cell(row + 1, 26).number(item.QTY_UM_WHOLESALE).style(style);
            worksheet.cell(row + 1, 27).string((item.CC_VALUE_UM_WHOLESALE ? item.CC_VALUE_UM_WHOLESALE : "")).style(style);
            worksheet.cell(row + 1, 28).number(item.QTY_UM_FARFETCH_S1).style(style);
            worksheet.cell(row + 1, 29).string(item.CC_VALUE_UM_FARFETCH_S1 ? item.CC_VALUE_UM_FARFETCH_S1 : "").style(style);
            worksheet.cell(row + 1, 30).number((item.QTY_UM_FARFETCH_S2)).style(style);
            worksheet.cell(row + 1, 31).string((item.CC_VALUE_UM_FARFETCH_S2 ? item.CC_VALUE_UM_FARFETCH_S2 : "")).style(style);

            worksheet.cell(row + 1, 32).number(item.QTY_UM_MODES_COM_S1).style(style);
            worksheet.cell(row + 1, 33).string(item.CC_VALUE_UM_MODES_COM_S1 ? item.CC_VALUE_UM_MODES_COM_S1 : "").style(style);
            worksheet.cell(row + 1, 34).number((item.QTY_UM_MODES_COM_S2)).style(style);
            worksheet.cell(row + 1, 35).string((item.CC_VALUE_UM_MODES_COM_S2 ? item.CC_VALUE_UM_MODES_COM_S2 : "")).style(style);

            worksheet.cell(row + 1, 36).number(item.QTY_UM_CONCIERGE_S1).style(style);
            worksheet.cell(row + 1, 37).string(item.CC_VALUE_UM_CONCIERGE_S1 ? item.CC_VALUE_UM_CONCIERGE_S1 : "").style(style);
            worksheet.cell(row + 1, 38).number(item.QTY_UM_CONCIERGE_S2).style(style);
            worksheet.cell(row + 1, 39).string(item.CC_VALUE_UM_CONCIERGE_S2 ? item.CC_VALUE_UM_CONCIERGE_S2 : "").style(style);
            worksheet.cell(row + 1, 40).number(item.QTY_UM_MARKETPLACE_S1).style(style);
            worksheet.cell(row + 1, 41).string(item.CC_VALUE_UM_MARKETPLACE_S1 ? item.CC_VALUE_UM_MARKETPLACE_S1 : "").style(style);
            worksheet.cell(row + 1, 42).number(item.QTY_UM_MARKETPLACE_S2).style(style);
            worksheet.cell(row + 1, 43).string(item.CC_VALUE_UM_MARKETPLACE_S2 ? item.CC_VALUE_UM_MARKETPLACE_S2 : "").style(style);
            worksheet.cell(row + 1, 44).number(item.QTY_UM_LISTE_S1).style(style);
            worksheet.cell(row + 1, 45).number(item.QTY_UM_LISTE_S2).style(style);
            worksheet.cell(row + 1, 46).string(item.CC_VALUE_UM_LISTE_S1 ? item.CC_VALUE_UM_LISTE_S1 : "").style(style);
            worksheet.cell(row + 1, 47).string(item.CC_VALUE_UM_LISTE_S2 ? item.CC_VALUE_UM_LISTE_S2 : "").style(style);
            worksheet.cell(row + 1, 48).number(item.QTY_UM_RETAIL_S1).style(style);
            worksheet.cell(row + 1, 49).string((item.CC_VALUE_UM_RETAIL_S1 ? item.CC_VALUE_UM_RETAIL_S1 : "")).style(style);
            worksheet.cell(row + 1, 50).number((item.QTY_UM_RETAIL_S2)).style(style);
            worksheet.cell(row + 1, 51).string(item.CC_VALUE_UM_RETAIL_S2 ? item.CC_VALUE_UM_RETAIL_S2 : "" ).style(style);
            worksheet.cell(row + 1, 52).number(item.CC_TOT_QTY_UM_S1 ).style(style);
            worksheet.cell(row + 1, 53).string(item.CC_TOT_VALUE_UM_S1 ? item.CC_TOT_VALUE_UM_S1 : "").style(style);
            worksheet.cell(row + 1, 54).number(item.CC_TOT_QTY_UM_S2 ).style(style);
            worksheet.cell(row + 1, 55).string(item.CC_TOT_VALUE_UM_S2 ? item.CC_TOT_VALUE_UM_S2 : "").style(style);
            worksheet.cell(row + 1, 56).string(item.CC_SELLTHROUGH_QTY_ORDERED_WH ? item.CC_SELLTHROUGH_QTY_ORDERED_WH : "").style(style);
            worksheet.cell(row + 1, 57).string(item.CC_SELLTHROUGH_QTY_RECEIVED_WH ? item.CC_SELLTHROUGH_QTY_RECEIVED_WH : "").style(style);
            worksheet.cell(row + 1, 58).string(item.CC_SELLTHROUGH_VALUE_ORDERED_WH ? item.CC_SELLTHROUGH_VALUE_ORDERED_WH : "").style(style);
            worksheet.cell(row + 1, 59).string((item.CC_SELLTHROUGH_VALUE_RECEIVED_WH ? item.CC_SELLTHROUGH_VALUE_RECEIVED_WH : "")).style(style);
            worksheet.cell(row + 1, 60).string((item.CC_SELLTHROUGH_QTY_ORDERED_NO_WH_S1 ? item.CC_SELLTHROUGH_QTY_ORDERED_NO_WH_S1 : "") ).style(style);
            worksheet.cell(row + 1, 61).string((item.CC_SELLTHROUGH_QTY_RECEIVED_NO_WH_S1 ? item.CC_SELLTHROUGH_QTY_RECEIVED_NO_WH_S1 : "")).style(style);
            worksheet.cell(row + 1, 62).string((item.CC_SELLTHROUGH_VALUE_ORDERED_NO_WH_S1 ? item.CC_SELLTHROUGH_VALUE_ORDERED_NO_WH_S1 : "")).style(style);
            worksheet.cell(row + 1, 63).string((item.CC_SELLTHROUGH_VALUE_RECEIVED_NO_WH_S1 ? item.CC_SELLTHROUGH_VALUE_RECEIVED_NO_WH_S1: "")).style(style);
            worksheet.cell(row + 1, 64).string((item.CC_SELLTHROUGH_QTY_ORDERED_NO_WH_S2 ? item.CC_SELLTHROUGH_QTY_ORDERED_NO_WH_S2 : "")).style(style);
            worksheet.cell(row + 1, 65).string(item.CC_SELLTHROUGH_QTY_RECEIVED_NO_WH_S2 ? item.CC_SELLTHROUGH_QTY_RECEIVED_NO_WH_S2 : "").style(style);
            worksheet.cell(row + 1, 66).string(item.CC_SELLTHROUGH_VALUE_ORDERED_NO_WH_S2 ? item.CC_SELLTHROUGH_VALUE_ORDERED_NO_WH_S2 : "").style(style);
            worksheet.cell(row + 1, 67).string(item.CC_SELLTHROUGH_VALUE_RECEIVED_NO_WH_S2 ? item.CC_SELLTHROUGH_VALUE_RECEIVED_NO_WH_S2 : "").style(style);
