		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ReportProtectionRules",
									"targetURL": "#ReportProtectionRulesreportprotectionrules-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ReportProtectionRulesreportprotectionrules-display": {
								"semanticObject": "ReportProtectionRulesreportprotectionrules",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ReportProtectionRules.reportprotectionrules",
									"url": sap.ui.require.toUrl("ReportProtectionRules/reportprotectionrules")
								}
							}
						}
					}
