		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "VendutoPerCanale",
									"targetURL": "#VendutoPerCanalevendutopercanale-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VendutoPerCanalevendutopercanale-display": {
								"semanticObject": "VendutoPerCanalevendutopercanale",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=VendutoPerCanale.vendutopercanale",
									"url": sap.ui.require.toUrl("VendutoPerCanale/vendutopercanale")
								}
							}
						}
					}
