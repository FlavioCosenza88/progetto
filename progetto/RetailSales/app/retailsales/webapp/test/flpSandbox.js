		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Retail Sales",
									"targetURL": "#modescomretailsales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"modescomretailsales-display": {
								"semanticObject": "modescomretailsales",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=modes.com.retailsales",
									"url": sap.ui.require.toUrl("modes/com/retailsales")
								}
							}
						}
					}
