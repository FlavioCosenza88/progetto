...
async function copyAndTrack(source, dest, context = {}, { force = false, projectDescriptor } = {}) {
    ...
    if (isdir(source)) {
        ...
        if (!force && await _isChartFileModified(dest, context)) {
            ...
            if (projectDescriptor) return copyRenderedYAML(source, dest, projectDescriptor)
