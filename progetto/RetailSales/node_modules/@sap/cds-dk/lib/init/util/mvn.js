        ...
        if (!params.get('-DjdkVersion')) {
            try {
                ...
                if (match?.[1]) {
                    ...
                    switch (true) {
                        case (version < 11): throw new CliError(`Java version ${match[1]} is not supported. Use Java 11 or higher.`);
                        case (version <= 16): params.set(`-DjdkVersion`, 11); break;
                        case (version > 16): params.set(`-DjdkVersion`, 17); break;
                        default:
                    }
                }
            } catch (err) {
