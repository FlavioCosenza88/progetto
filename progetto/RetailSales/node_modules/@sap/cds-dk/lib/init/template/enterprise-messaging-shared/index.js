...
module.exports = class EnterpriseMessagingSharedTemplate extends require('../templateBase') {
  ...
  static hasFacet(env) {
    return env.requires?.messaging?.kind === 'enterprise-messaging-shared'
  }
