...
module.exports = class RedisMessagingTemplate extends require('../templateBase') {
  ...
  async canRun() {
    ...
    const { hasMta, hasHelm, isJava } = projectDescriptor.cap
