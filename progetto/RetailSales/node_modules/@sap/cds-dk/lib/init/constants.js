...
const MAVEN_ARCHETYPE_VERSION = '1.34.0';
...
const constants = {
    ...
    OPTION_ENTERPRISE_MESSAGING_SHARED: 'enterprise-messaging-shared',
    OPTION_FILE_BASED_MESSAGING: 'file-based-messaging',
    OPTION_REDIS_MESSAGING: 'redis-messaging',
...
constants.OPTIONS_PRIORITY = [
    ...
    constants.OPTION_SQLITE,
    constants.OPTION_AUDITLOG,
    constants.OPTION_ENTERPRISE_MESSAGING,
    constants.OPTION_ENTERPRISE_MESSAGING_SHARED,
    constants.OPTION_FILE_BASED_MESSAGING,
    constants.OPTION_REDIS_MESSAGING,
