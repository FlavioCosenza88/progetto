...
# SYNOPSIS
    ...
    *cds login* [ <app-url> ]
    ...
    Simplifies usage of multitenancy-related commands (e.g. *cds subscribe* and *cds push*)
    by providing them with automatic authentication: fetches and saves authentication
    tokens and provides relevant tokens to those commands. Alternatively saves username
    for apps running locally.
...
# OPTIONS
    ...
    *-c* | *--client* <clientid>[:<clientsecret>]
        ...
        Client Credentials (Client ID and optionally Client Secret) for authentication.
        If omitted, Client Secret will be queried interactively.
    ...
    *-m* | *--mtls* <clientid>[:<key>]
        ...
        Client Credentials (Client ID and optionally Client-Certificate Private Key in Base64 encoding)
        for authentication. If omitted, Private Key will be queried interactively (avoid newline characters
        when pasting it).
...
# SEE ALSO
    ...
    Supported commands: *cds subscribe*, *cds upgrade*, *cds pull*, *cds push*, and *cds unsubscribe*.
